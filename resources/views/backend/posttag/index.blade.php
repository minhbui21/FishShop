 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            @foreach($postTags as $data)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('post-tag.edit',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Chỉnh sửa" data-placement="bottom"><i class="fas fa-edit"></i></a>
        ...
        @else
          <h6 class="text-center">Chưa có Tag!!! Hãy thêm Tag.</h6>
        @endif
      </div>
    </div>
</div>
