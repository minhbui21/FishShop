...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Thêm không thành công, hãy thử lại!');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Cập nhật không thành công, hãy thử lại!');
        }
        return redirect()->route('brand.index');
    }
    ...
    public function destroy($id)
    {
        ...
        if($brand){
            ...
            if($status){
                ...
                request()->session()->flash('error','Xóa không thành công, hãy thử lại!');
            }
            return redirect()->route('brand.index');
        }
        else{
