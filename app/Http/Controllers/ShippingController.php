...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            request()->session()->flash('success','Thêm phí giao hàng thành công');
        }
        else{
    ...
    public function edit($id)
    {
        ...
        if(!$shipping){
            request()->session()->flash('error','Không tìm thấy phí giao hàng');
        }
    ...
    public function destroy($id)
    {
        ...
        if($shipping){
            ...
            if($status){
                request()->session()->flash('success','Đã xóa phí giao hàng');
            }
            else{
                request()->session()->flash('error','Lỗi! Hãy thử lại.');
            }
